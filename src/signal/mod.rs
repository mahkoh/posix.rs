...
pub fn kill(pid: ::sys::types::pid_t, sig: ::int_t) -> ::int_t {
    extern { fn kill(pid: ::sys::types::pid_t, sig: ::int_t) -> ::int_t; }
    unsafe { kill(pid, sig) }
}

pub fn killpg(pid: ::sys::types::pid_t, sig: ::int_t) -> ::int_t {
    extern { fn killpg(pid: ::sys::types::pid_t, sig: ::int_t) -> ::int_t; }
...
pub fn pthread_kill(threadid: ::sys::types::pthread_t, signo: ::int_t) -> ::int_t {
    extern { fn pthread_kill(id: ::sys::types::pthread_t, signo: ::int_t) -> ::int_t; }
...
pub fn sigqueue(pid: ::sys::types::pid_t, sig: ::int_t, val: sigval) -> ::int_t {
    extern { fn sigqueue(pid: ::sys::types::pid_t, sig: ::int_t, val: sigval) -> ::int_t; }
