...
pub fn clock() -> ::sys::types::clock_t {
    extern { fn clock() -> ::sys::types::clock_t; }
    unsafe { clock() }
}

pub fn clock_getcpuclockid(pid: ::sys::types::pid_t,
                           clock_id: &mut ::sys::types::clockid_t) -> ::int_t {
    extern {
        fn clock_getcpuclockid(pid: ::sys::types::pid_t,
                               clock_id: *mut ::sys::types::clockid_t) -> ::int_t;
    }
    unsafe { clock_getcpuclockid(pid, clock_id as *mut _) }
}

pub fn clock_getres(id: ::sys::types::clockid_t, res: &mut timespec) -> ::int_t {
    extern {
        fn clock_getres(id: ::sys::types::clockid_t, res: *mut timespec) -> ::int_t;
    }
    unsafe { clock_getres(id, res as *mut _) }
}

pub fn clock_gettime(id: ::sys::types::clockid_t, res: &mut timespec) -> ::int_t {
    extern {
        fn clock_gettime(id: ::sys::types::clockid_t, res: *mut timespec) -> ::int_t;
    }
    unsafe { clock_gettime(id, res as *mut _) }
}

pub fn clock_nanosleep(id: ::sys::types::clockid_t, flags: ::int_t, req: &timespec,
                       remain: Option<&mut timespec>) -> ::int_t {
    extern {
        fn clock_nanosleep(clock_id: ::sys::types::clockid_t, flags: ::int_t,
...
pub fn clock_settime(id: ::sys::types::clockid_t, res: &timespec) -> ::int_t {
    extern {
        fn clock_settime(id: ::sys::types::clockid_t, res: *const timespec) -> ::int_t;
    }
    unsafe { clock_settime(id, res as *const _) }
}

pub fn difftime(time1: ::sys::types::time_t, time0: ::sys::types::time_t) -> f64 {
    extern {
        fn difftime(time1: ::sys::types::time_t,
                    time0: ::sys::types::time_t) -> ::double_t;
    }
    unsafe { difftime(time1, time0) }
}

pub fn gmtime_r(timep: &::sys::types::time_t, res: &mut tm) {
    extern {
        fn gmtime_r(timer: *const ::sys::types::time_t, tp: *mut tm) -> *mut tm;
    }
    unsafe { gmtime_r(timep as *const _, res as *mut _); }
}

pub fn localtime_r(timep: &::sys::types::time_t, res: &mut tm) {
    extern {
        fn localtime_r(timer: *const ::sys::types::time_t, tp: *mut tm) -> *mut tm;
    }
    unsafe { localtime_r(timep as *const _, res as *mut _); }
}

pub fn mktime(tm: &mut tm) -> ::sys::types::time_t {
    extern {
        fn mktime(tp: *mut tm) -> ::sys::types::time_t;
    }
...
pub fn strftime_l<T: ::NTStr>(dst: &mut [u8], fmt: &T, tm: &tm,
                            locale: ::locale::locale_t) -> ::size_t {
    extern {
        fn strftime_l(s: *mut ::char_t, max: ::size_t, format: *const ::char_t,
                    tp: *const tm, locale: ::locale::locale_t) -> ::size_t;
    }
...
pub fn time() -> ::sys::types::time_t {
    extern { fn time(timer: *mut ::sys::types::time_t) -> ::sys::types::time_t; }
    unsafe { time(0 as *mut _) }
}

pub fn timer_create(id: ::sys::types::clockid_t, evp: &mut ::signal::sigevent,
                    timerid: &mut ::sys::types::timer_t) -> ::int_t {
    extern { 
        fn timer_create(clock_id: ::sys::types::clockid_t, evp: *mut ::signal::sigevent,
                        timerid: *mut ::sys::types::timer_t) -> ::int_t;
    }
    unsafe { timer_create(id, evp as *mut _, timerid as *mut _) }
}

pub fn timer_delete(timerid: ::sys::types::timer_t) -> ::int_t {
    extern { fn timer_delete(timerid: ::sys::types::timer_t) -> ::int_t; }
    unsafe { timer_delete(timerid) }
}

pub fn timer_getoverrun(timerid: ::sys::types::timer_t) -> ::int_t {
    extern { fn timer_getoverrun(timerid: ::sys::types::timer_t) -> ::int_t; }
    unsafe { timer_getoverrun(timerid) }
}

pub fn timer_gettime(timerid: ::sys::types::timer_t, tm: &mut itimerspec) -> ::int_t {
    extern {
        fn timer_gettime(timerid: ::sys::types::timer_t,
                         value: *mut itimerspec) -> ::int_t;
    }
    unsafe { timer_gettime(timerid, tm as *mut _) }
}

pub fn timre_settime(id: ::sys::types::timer_t, flags: ::int_t, v: &itimerspec,
                     o: Option<&mut itimerspec>) -> ::int_t {
    extern {
        fn timer_settime(timerid: ::sys::types::timer_t, flags: ::int_t,
...
extern "C" {
    ...
    pub fn ctime(timer: *const ::sys::types::time_t) -> *mut ::char_t;
    pub fn ctime_r(timer: *const ::sys::types::time_t, buf: *mut ::char_t) -> *mut ::char_t;
    pub fn getdate(string: *const ::char_t) -> *mut tm;
    pub fn gmtime(timer: *const ::sys::types::time_t) -> *mut tm;
    pub fn localtime(timer: *const ::sys::types::time_t) -> *mut tm;
}
