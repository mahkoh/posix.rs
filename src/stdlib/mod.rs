...
extern {
    ...
    pub fn mbstowcs(pwcs: *mut ::stddef::wchar_t, s: *const ::char_t, n: ::size_t) -> ::size_t;
    pub fn mbtowc(pwc: *mut ::stddef::wchar_t, s: *const ::char_t, n: ::size_t) -> ::int_t;
    ...
    pub fn wcstombs(s: *mut ::char_t, pwcs: *const ::stddef::wchar_t, n: ::size_t) -> ::size_t;
    pub fn wctomb(s: *mut ::char_t, wchar: ::stddef::wchar_t) -> ::int_t;
}
