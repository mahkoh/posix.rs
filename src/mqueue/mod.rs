...
pub fn mq_notify(mqdes: mqd_t, notification: &::signal::sigevent) -> ::int_t {
    extern { fn mq_notify(mqdes: mqd_t,
                          notification: *const ::signal::sigevent) -> ::int_t; }
...
pub fn mq_open<T: ::NTStr>(name: &T, oflag: ::int_t, mode: Option<::sys::types::mode_t>,
