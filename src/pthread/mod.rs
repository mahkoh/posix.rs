...
use sys::types::pthread_attr_t        as attr;
use sys::types::pthread_barrierattr_t as barrierattr;
use sys::types::pthread_barrier_t     as barrier;
use sys::types::pthread_condattr_t    as condattr;
use sys::types::pthread_cond_t        as cond;
use sys::types::pthread_key_t         as key;
use sys::types::pthread_mutexattr_t   as mutexattr;
use sys::types::pthread_mutex_t       as mutex;
use sys::types::pthread_once_t        as _once;
use sys::types::pthread_rwlockattr_t  as rwlockattr;
use sys::types::pthread_rwlock_t      as rwlock;
use sys::types::pthread_spinlock_t    as spinlock;
use sys::types::pthread_t             as thread;
